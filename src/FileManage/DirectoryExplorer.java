...
import ParkingSystem.ParkingLogger;

import java.io.File;
import java.util.Scanner;
import java.io.IOException;

import static FileManage.DirectoryRecursiveList.directoryList;
                ...
                if (file.exists()) {
                    ...
                    if (createChoice.equals("1")) {
                        ...
                        if (!parentDir.exists()) {
                            ...
                            if (!created) {
                                System.out.println("The parent directory couldn't be created");
                                continue;
                            }
                        }
                        ...
                        if (created) {
                            System.out.println("The directory successfully created");
                        } else {
